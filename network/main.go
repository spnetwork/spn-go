// Package network contains functions that deal with spn network passphrases
// and IDs.
package network
...
import (
	...
	"github.com/spn/go/hash"
	"github.com/spn/go/support/errors"
	"github.com/spn/go/xdr"
)

const (
	// PublicNetworkPassphrase is the pass phrase used for every transaction intended for the public spn network
	PublicNetworkPassphrase = "Public Global Spn Network ; September 2015"
...
// resulting hash is the value that can be signed by spn secret key to
// authorize the transaction identified by the hash to spn validators.
