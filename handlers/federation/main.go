// Package federation provides a pluggable handler that satisfies the Spn
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided spn address.
...
// conform to the Spn federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// spn account id to lookup, such as
