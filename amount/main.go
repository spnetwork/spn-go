...
// the format used internally to spn-core.
//
// spn-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, horizon, the client-libraries and other built
// on top of spn-core use a convention, encoding amounts as a string of
...
// represented in spn-core as 1010010000.
package amount
...
// One is the value of one whole unit of currency. Spn uses 7 fixed digits
...
var (
	...
	// Note: {1,20} because the biggest amount you can use in Spn is:
...
// Parse parses the provided as a spn "amount", i.e. a 64-bit signed integer
...
// ParseInt64 parses the provided as a spn "amount", i.e. a 64-bit signed
...
// IntStringToAmount converts string integer value and converts it to spn
