...
// structures used by the spn network, most importanly transactions.
//
...
var (
	...
	// to the main public spn network.
...
// Network establishes the spn network that a transaction should apply to.
