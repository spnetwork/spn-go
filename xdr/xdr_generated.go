...
// SpnValueExt is an XDR NestedUnion defines as:
//
//   union switch (int v)
//        {
//        case 0:
...
//        }
//
type SpnValueExt struct {
	V int32
}

// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u SpnValueExt) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of SpnValueExt
func (u SpnValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch int32(sw) {
	case 0:
		return "", true
	}
...
// NewSpnValueExt creates a new  SpnValueExt.
func NewSpnValueExt(v int32, value interface{}) (result SpnValueExt, err error) {
	result.V = v
	switch int32(v) {
	case 0:
		// void
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s SpnValueExt) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *SpnValueExt) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*SpnValueExt)(nil)
	_ encoding.BinaryUnmarshaler = (*SpnValueExt)(nil)
)

// SpnValue is an XDR Struct defines as:
//
//   struct SpnValue
//    {
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s SpnValue) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *SpnValue) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*SpnValue)(nil)
	_ encoding.BinaryUnmarshaler = (*SpnValue)(nil)
)
...
//        SpnValue scpValue;   // what consensus agreed to
...
// SpnMessage is an XDR Union defines as:
//
//   union SpnMessage switch (MessageType type)
//    {
//    case ERROR_MSG:
//        Error error;
//    case HELLO:
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u SpnMessage) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of SpnMessage
func (u SpnMessage) ArmForSwitch(sw int32) (string, bool) {
...
// NewSpnMessage creates a new  SpnMessage.
func NewSpnMessage(aType MessageType, value interface{}) (result SpnMessage, err error) {
	result.Type = aType
...
// panicing if the value is not set.
func (u SpnMessage) MustError() Error {
	val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustHello() Hello {
	val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustAuth() Auth {
	val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustPeers() []PeerAddress {
	val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustTxSet() TransactionSet {
	val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustQSet() ScpQuorumSet {
	val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u SpnMessage) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u SpnMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s SpnMessage) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *SpnMessage) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*SpnMessage)(nil)
	_ encoding.BinaryUnmarshaler = (*SpnMessage)(nil)
)
