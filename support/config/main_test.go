...
func TestAccountIDValidator(t *testing.T) {
	var val struct {
		Empty        string `valid:"spn_accountid"`
		NotSTRKey    string `valid:"spn_accountid"`
		NotAccountID string `valid:"spn_accountid"`
		Valid        string `valid:"spn_accountid"`
		WrongType    int    `valid:"spn_accountid"`
	}
...
func TestSeedValidator(t *testing.T) {
	var val struct {
		Empty     string `valid:"spn_seed"`
		NotSTRKey string `valid:"spn_seed"`
		NotSeed   string `valid:"spn_seed"`
		Valid     string `valid:"spn_seed"`
		WrongType int    `valid:"spn_seed"`
	}
