// Package address provides utility functions for working with spn
// addresses. See https://www.spn.org/developers/guides/concepts/federation.
// html#spn-addresses for more on addresses.
package address
