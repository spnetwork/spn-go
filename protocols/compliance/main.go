...
type AuthData struct {
	// The spn address of the customer that is initiating the send.
	Sender string `json:"sender" valid:"required,spn_address"`
...
type AuthResponse struct {
	...
	// (only present if info_status is ok) JSON of the recipient's AML information. in the Spn attachment convention
...
// Transaction represents transaction field in Spn attachment
...
// Operation represents a single operation object in Spn attachment
