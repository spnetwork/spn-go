...
const (
	// SpnAccountPrefix is a prefix for Spn key pairs derivation.
	SpnAccountPrefix = "m/44'/148'"
	// SpnPrimaryAccountPath is a derivation path of the primary account.
	SpnPrimaryAccountPath = "m/44'/148'/0'"
	// SpnAccountPathFormat is a path format used for Spn key pair
	// derivation as described in SEP-00XX. Use with `fmt.Sprintf` and `DeriveForPath`.
	SpnAccountPathFormat = "m/44'/148'/%d'"
