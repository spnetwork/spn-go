...
import (
	...
	"github.com/spn/go/handlers/federation"
	"github.com/spn/go/support/app"
	"github.com/spn/go/support/config"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "federation",
		Short: "spn federation server",
		Long: `
The spn federation server let's you easily integrate the spn federation
