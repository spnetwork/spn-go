...
// TransactionSubmitter submits transactions to Spn Network
...
// LoadAccount loads current state of Spn account and creates a map entry if it didn't exist
...
// SubmitTransaction builds and submits transaction to Spn network
