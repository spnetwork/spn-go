...
// validated transactions and sends it to SpnAccountConfigurator for account configuration.
func (s *Server) poolTransactionsQueue() {
	...
	for {
		...
		go s.SpnAccountConfigurator.ConfigureAccount(
			transaction.SpnPublicKey,
