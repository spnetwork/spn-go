...
import (
	...
	"github.com/spn/go/support/time"
...
// GetAddress retrieves a spn address.  It confirms the value loaded is a
// valid spn address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a spn
...
// the string at the provided name in accordance with the spn client
// conventions
