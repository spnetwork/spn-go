...
import (
	...
	protocol "github.com/spn/go/protocols/horizon"
...
func TestLargeAmount(t *testing.T) {
	row := assets.AssetStatsR{
		...
		NumAccounts: 429,
		Flags:       0,
		Toml:        "https://xim.com/.well-known/spn.toml",
	}
	...
	assert.Equal(t, "https://xim.com/.well-known/spn.toml", res.Links.Toml.Href)
}
