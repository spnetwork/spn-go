...
// data produced by the connected spn-core database, transforms it and
...
// Cursor iterates through a spn core database's ledgers
type Cursor struct {
	...
	// CoreDB is the spn-core db that data is ingested from.
	CoreDB *db.Session
...
type System struct {
	...
	Network string
	// SpnCoreURL is the http endpoint of the spn-core that data is being
	// ingested from.
	SpnCoreURL string
...
// New initializes the ingester, causing it to begin polling the spn-core
