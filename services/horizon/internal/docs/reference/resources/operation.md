...
[Operations](https://www.spn.org/developers/learn/concepts/operations.html) are objects that represent a desired change to the ledger: payments,
offers to exchange currency, changes made to account options, etc.  Operations
are submitted to the Spn network grouped in a [Transaction](./transaction.md).

To learn more about the concept of operations in the Spn network, take a look at the [Spn operations concept guide](https://www.spn.org/developers/learn/concepts/operations.html).

## Operation Types

| type                                          | type_i | description                                                                                                |
|-----------------------------------------------|--------|------------------------------------------------------------------------------------------------------------|
| [CREATE_ACCOUNT](#create-account)             | 0      | Creates a new account in Spn network.
| [PAYMENT](#payment)                           | 1      | Sends a simple payment between two accounts in Spn network.
| [PATH_PAYMENT](#path-payment)                 | 2      | Sends a path payment between two accounts in the Spn network.
| [MANAGE_OFFER](#manage-offer)                 | 3      | Creates, updates or deletes an offer in the Spn network.
...
offer to trade assets in the Spn network.
