...
directly reflected in the [ledger](https://www.spn.org/developers/learn/concepts/ledger.html) or [history](https://github.com/spn/spn-core/blob/master/docs/history.md), as [transactions](https://www.spn.org/developers/learn/concepts/transactions.html) and [operations](https://www.spn.org/developers/learn/concepts/operations.html) are.
