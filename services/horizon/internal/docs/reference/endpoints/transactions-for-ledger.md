...
clientData:
  laboratoryUrl: https://www.spn.org/laboratory/#explorer?resource=transactions&endpoint=for_ledger
---
...
```sh
curl "https://horizon-testnet.spn.org/ledgers/69859/transactions"
```
