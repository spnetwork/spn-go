...
clientData:
  laboratoryUrl: https://www.spn.org/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://horizon-testnet.spn.org/operations/77309415424/effects"
```
