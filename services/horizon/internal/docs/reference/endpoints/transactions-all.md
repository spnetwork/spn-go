...
clientData:
  laboratoryUrl: https://www.spn.org/laboratory/#explorer?resource=transactions&endpoint=all
---
...
This endpoint can also be used in [streaming](../streaming.md) mode. This makes it possible to use it to listen for new transactions as they get made in the Spn network.
...
curl "https://horizon-testnet.spn.org/transactions?limit=200&order=desc"
```
