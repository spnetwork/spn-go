...
```shell
$ curl -X GET "https://horizon-testnet.spn.org/transactions?cursor=1&order=desc"
{
  "type": "before_history",
  "title": "Data Requested Is Before Recorded History",
  "status": 410,
  "detail": "This horizon instance is configured to only track a portion of the spn network's latest history. This request is asking for results prior to the recorded history known to this horizon instance.",
  "instance": "horizon-testnet-001.prd.spn001.internal.spn-ops.com/ngUFNhn76T-078058"
}
```
