...
```bash
$ curl -X GET -H "Accept: application/xml" "https://horizon-testnet.spn.org/accounts/GALWEV6GY73RJ255JC7XUOZ2L7WZ5JJDTKATB2MUK7F3S67DVT2A6R5G"
{
  "type": "not_acceptable",
  "title": "An acceptable response content-type could not be provided for this request",
  "status": 406,
  "instance": "horizon-testnet-001.prd.spn001.internal.spn-ops.com/hCYL7oezXs-062662"
}
```
