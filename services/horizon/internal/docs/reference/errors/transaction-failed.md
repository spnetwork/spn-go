...
| `result_xdr`               | String | A base64-encoded representation of the TransactionResult XDR returned by spn-core when submitting this transactions.    |
| `result_codes.transaction` | String | The transaction result code returned by spn-core.                                                                       |
