...
import (
	...
	results "github.com/spn/go/services/horizon/internal/txsub/results/db"
	"github.com/spn/go/services/horizon/internal/txsub/sequence"
)
...
func initSubmissionSystem(app *App) {
	...
	app.submitter = &txsub.System{
		...
		Submitter:       txsub.NewDefaultSubmitter(http.DefaultClient, app.config.SpnCoreURL),
