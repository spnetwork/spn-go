...
// be submitted to the backing spn-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to spn-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to spn-core
