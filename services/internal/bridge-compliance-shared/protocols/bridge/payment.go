...
import (
	...
	"github.com/spn/go/keypair"
	"github.com/spn/go/services/internal/bridge-compliance-shared/http/helpers"
	"github.com/spn/go/services/internal/bridge-compliance-shared/protocols"
	complianceServer "github.com/spn/go/services/internal/bridge-compliance-shared/protocols/compliance"
...
var (
	...
	PaymentCannotResolveDestination = &helpers.ErrorResponse{Code: "cannot_resolve_destination", Message: "Cannot resolve federated Spn address.", Status: http.StatusBadRequest}
...
type PaymentRequest struct {
	...
	Source string `form:"source" valid:"optional,spn_seed"`
	// Sender address (like alice*spn.org)
	Sender string `form:"sender" valid:"optional,spn_address"`
	// Destination address (like bob*spn.org)
	Destination string `form:"destination" valid:"optional,spn_destination"`
	// ForwardDestination
	...
	Amount string `form:"amount" valid:"required,spn_amount"`
	// Code of the asset destination should receive
	AssetCode string `form:"asset_code" valid:"optional,spn_asset_code"`
	// Issuer of the asset destination should receive
	AssetIssuer string `form:"asset_issuer" valid:"optional,spn_accountid"`
	// Only for path_payment
	SendMax string `form:"send_max" valid:"optional,spn_amount"`
	// Only for path_payment
	SendAssetCode string `form:"send_asset_code" valid:"optional,spn_asset_code"`
	// Only for path_payment
	SendAssetIssuer string `form:"send_asset_issuer" valid:"optional,spn_accountid"`
