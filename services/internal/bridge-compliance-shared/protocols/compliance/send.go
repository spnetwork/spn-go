...
type SendRequest struct {
	...
	// Source account ID
	Source string `form:"source" valid:"required,spn_accountid"`
	// Sender address (like alice*spn.org)
	Sender string `form:"sender" valid:"required,spn_address"`
	// Destination address (like bob*spn.org)
	Destination string `form:"destination" valid:"required,spn_address"`
	// ForwardDestination
